...
| 0:25–0:50 | Browser: Streamlit sidebar | “Users **bring their own CSVs** — we are not scraping stores in the core story. For the video I’ll load our **sample** reviews and market file.” Click **Load built-in sample data**. |
...
| 3:55–4:25 | **Executive brief** (scroll) | “The brief **does not invent statistics** — it repeats what we computed plus **quoted** snippets. Optional API polish only **rephrases** under a strict prompt.” |
